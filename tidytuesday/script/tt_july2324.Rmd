...
grid_plot <- wrap_plots(plots, ncol = 7, width = 1) +
    plot_annotation(title = "American Idol: Most Performed Artist",
                    subtitle = "Elton John, Stevie Wonder, and The Beattles were the most performed",
...
state_plot <- ggplot(audition_finalist_state, 
       aes(x = audition, y = finalist)) +
    geom_jitter(aes(size = bubble_size, color = bubble_size), position = position_jitter(seed = 1))+
